...
test("@remnic/core exposes the peers public subpath", async () => {
  ...
  assert.deepEqual(pkg.exports?.["./peers"], expected);
  assert.deepEqual(pkg.exports?.["./peers.js"], expected);
  assert.deepEqual(pkg.exports?.["./peers/index"], expected);
  assert.deepEqual(pkg.exports?.["./peers/index.js"], expected);
});
